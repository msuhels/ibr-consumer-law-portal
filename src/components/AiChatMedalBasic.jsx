...
function AiChatMedalBasic({
    ...
    return (
        <>
            ...
            >
                <div ref={modalContent} className="bg-white dark:bg-slate-800 shadow-lg overflow-auto max-w-3xl w-full max-h-full"
                    style={{
                        border: "2px solid ",
                        borderImageSource: "linear-gradient(180deg, #F86A68 0%, rgba(101, 13, 11, 0.1) 100%)",
...
export default AiChatMedalBasic;