  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-question-mark" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#64758b" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M8 8a3.5 3 0 0 1 3.5 -3h1a3.5 3 0 0 1 3.5 3a3 3 0 0 1 -2 3a3 4 0 0 0 -2 4" />
          <path className="fill-current text-slate-500 dark:text-slate-400" d="M12 19l0 .01" />
        </svg>
      </button>
      ...
      >
        ...
        >
          ...
          <ul>
            ...
            <li>
              <a
                 target="_blank" className="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                href="https://www.consumerlawdispute.ai/contact/"
              // onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-indigo-300 dark:text-indigo-500 shrink-0 mr-2" viewBox="0 0 12 12">
