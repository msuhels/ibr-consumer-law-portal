    ...
    <div {...rest} className='flex flex-col relative '>
      <button
        ...
        className={`rounded-full ${dropdownOpen
          ...
          : 'inline-flex items-center justify-center text-xs md:text-sm  font-medium leading-5 rounded-[20px] px-3 py-3 border bg-slate-200 text-black ms-2'
          }`}
        aria-haspopup="true"
...
export default DashboardEditMenu;