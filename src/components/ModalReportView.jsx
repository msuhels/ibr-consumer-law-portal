                      ...
                      <table className="table-auto w-full dark:text-slate-300">
                        ...
                        <tbody className="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                          ...
                          <tr>
                            ...
                            <td className="py-2">
                              <div className="font-medium text-right  text-red-500">-</div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                              ...
                              <tr key={i}>
                                {val.latePaymentSummary !== "" ?
                                  <>
                                    ...
                                    <td className="py-5 px-5">
                                      <div className="text-center">
                                        {Object.keys(val?.latePaymentCounts?.Equifax).length > 0 ?
                                          <>
                                    ...
                                    <td className="py-5 px-5">
                                      <div className="text-center">
                                        {Object.keys(val?.latePaymentCounts?.TransUnion).length > 0 ?
                                          <>
                                            <div className='text-lg	font-extrabold text-red-700'>X</div>
                                            <div className='text-xs	'>Negative</div>
                                          </>
                                    ...
                                    <td className="py-5 px-5">
                                      <div className="text-center">
                                        {Object.keys(val?.latePaymentCounts?.Experian).length > 0 ?
                                          <>
                                            <div className='text-lg	font-extrabold text-red-700'>X</div>
                                            <div className='text-xs	'>Negative</div>
                                          </>
