...
function ChatsChannelMenu() {
    ...
    return (
      <div className="relative">
        ...
        >
          {/* <img className="w-8 h-8 rounded-full mr-2" src={head_logo} width="32" height="32" alt="Group 01" /> */}
          <div className="truncate">
            <span className="font-bold text-xl text-[#080D18]">Chat</span>
          </div>
          {/* <svg className="w-4 h-4 shrink-0 ml-2 mb-1 fill-current text-[#080D18]" viewBox="0 0 12 12">
...
export default ChatsChannelMenu;